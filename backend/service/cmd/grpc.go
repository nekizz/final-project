...
import (
	...
	"github.com/nekizz/final-project/backend/service/service"
)

var grpcCmd = &cobra.Command{
	Use:   "grpc",
	Short: "service-sale service serve grpc command",
	Run:   runGrpcCommand,
}
...
func initializeServices(orm *gorm.DB, grpcServer *grpc.Server) *grpc.Server {
	...
	pb.RegisterServiceServiceServer(grpcServer, serviceService)
