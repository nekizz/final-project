            ...
            <form className={cx('login-form')}>
                ...
                <div className={cx('input-container')}>
                    ...
                    <input
                        ...
                        placeholder={currentAccount ? 'Enter your password' : 'Enter your number'}
                    />
                </div>
                <p className={cx('login-note')}>We’ll call or text you to confirm your number. Standard message and data rates apply.</p>
